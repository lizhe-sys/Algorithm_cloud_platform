...
//@Service
//@Slf4j
//public class MeasurementApiImpl_bak implements MeasurementApi {
//
//
//    @Override
...
//                // tag条件筛选
//                + " and " + "\"" + tagKey + "\"= " + " \'" + tagValue + "\' group by MotorNo";
//
//
...
//        MeasurementApiImpl_bak measurementApi = new MeasurementApiImpl_bak();
